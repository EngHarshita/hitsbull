...
* Two nested loops are used to check every possible pair in the array.<br>
* The outer loop selects the first element.<br>
* The inner loop checks elements after the current index to avoid repetition.<br>
