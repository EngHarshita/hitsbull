...
1. **Aggregation (loosely coupled relationship)**
2. **Composition (tightly coupled relationship)**
...
1. Department exists independently of University.
2. University receives a Department object from outside.
3. Changes made to Department are reflected in University.
4. This shows a has-a relationship with loose coupling.
